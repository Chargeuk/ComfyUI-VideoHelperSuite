    ...
    def INPUT_TYPES(s):
        ...
        return {"required": {
                ...
                "optional": {
                    ...
                    "vts_start_sequence": ("INT", {"default": 0, "min": 0, "step": 1}),
                    "vts_output_dir": ("STRING", {"default": "./tmp/images", "multiline": False}),
                    "vts_format": (["jpg", "webp", "png"], {"default": "jpg"}),
                    "vts_num_workers": ("INT", {"default": 16, "min": 1, "step": 1}),
                    "vts_compression_level": ("INT", {"default": 9, "min": 0, "max": 9, "step": 1, "tooltip": "PNG compression 0-9 or WebP method 0-6; ignored for JPG."}),
                    "vts_quality": ("INT", {"default": 95, "min": 1, "max": 101, "step": 1, "tooltip": "JPG/WebP quality 1-100, or 101 for lossless WebP."}),
